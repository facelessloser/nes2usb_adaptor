...
long turboSinceOne1 = 0;
long turboSinceOne2 = 100;
long turboWaitOne1 = 100;
long turboWaitOne2 = 200;

long turboSinceTwo1 = 0;
long turboSinceTwo2 = 20;
long turboWaitTwo1 = 20;
long turboWaitTwo2 = 40;
...
void loop() {
  ...
  if (turboSwitch == HIGH)
  {
   ...
   // A
    if (state & NES_A)
    {
      if(!a)
      {
        if (millis() - turboSinceOne1 >= turboWaitOne1)
        {
          turboSinceOne1 = millis();
          Joystick.pressButton(0);
        }
        if (millis() - turboSinceOne2 >= turboWaitOne2)
        {
          turboSinceOne2 = millis();
  ...
  // B
    if (state & NES_B)
    {
      if(!b)
      {
        if (millis() - turboSinceTwo1 >= turboWaitTwo1)
        {
          turboSinceTwo1 = millis();
          Joystick.pressButton(1);
        }
        if (millis() - turboSinceTwo2 >= turboWaitTwo2)
        {
          turboSinceTwo2 = millis();
